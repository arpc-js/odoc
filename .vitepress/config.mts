    ...
    vite: {
        plugins: [
            compression({
                ...
                ext: '.br',
                threshold: 100,            // >1KB 才压缩
                deleteOriginFile: false,    // 保留原文件
                compressionOptions: { level: 11 },
                filter: /\.(js|mjs|json|css|html|svg)$/i, // 默认已经包含这些
            })
        ]
    },
    locales: {
...
// 前端
                    ...
                    '/java/': [
                        ...
                        {
                            text: 'java编程(计算+存储)', collapsed: true, items: [
                                { text: '环境搭建', link: '/java/basic/env' },
                                { text: '计算', link: '/java/basic/compute' },
                                { text: '存储', link: '/java/basic/storage' },
                                { text: '条件分支', link: '/java/basic/if' },
                                { text: '循环分支', link: '/java/basic/for' },
                                { text: '函数', link: '/java/basic/function' },
                                { text: '类和方法', link: '/java/basic/class' },
                                /*
                                                        { text: '项目实战', link: '/java/basic/project' }
                                */
                            ]
                        },
                        /*                {
                        ...
                        {
                            text: 'http接口(远程通信)', collapsed: true, items: [
                        ...
                        {
                            text: '数据库(持久化存储)', collapsed: true, items: [
                        ...
                        {
                            text: '部署(域名公网访问，可选)', collapsed: true, items: [
                                { text: 'MySQL 基础操作', link: '/java/database/mysql_basic' },
                                { text: '事务与连接池', link: '/java/database/mysql_transactions' },
                                { text: 'MyBatis 使用', link: '/java/database/mybatis' },
                                { text: 'Redis 使用', link: '/java/database/redis' }
                        ...
                        {
                            text: 'vue(可选前端)', collapsed: true, items: [
                                { text: 'MySQL 基础操作', link: '/java/database/mysql_basic' },
                                { text: '事务与连接池', link: '/java/database/mysql_transactions' },
                                { text: 'MyBatis 使用', link: '/java/database/mybatis' },
                                { text: 'Redis 使用', link: '/java/database/redis' }
                        ...
                        {
                            text: '小程序(可选前端)', collapsed: true, items: [
                                { text: 'MySQL 基础操作', link: '/java/database/mysql_basic' },
                                { text: '事务与连接池', link: '/java/database/mysql_transactions' },
                                { text: 'MyBatis 使用', link: '/java/database/mybatis' },
                                { text: 'Redis 使用', link: '/java/database/redis' }
            ...
            themeConfig: {
                ...
                sidebar: {
                    '/es/guide/': [
                        ...
                        { text: 'Empezar', link: '/es/guide/getting-started' }
                    ]
                }
            }
        }
...
// 前端
            ...
            '/java/': [
                ...
                {
                    text: 'java编程(计算+存储)', collapsed: true, items: [
                        { text: '计算机介绍', link: '/java/basic/cunchu' },
                        { text: '计算机介绍', link: '/java/basic/brief' },
                        { text: '环境搭建', link: '/java/basic/env' },
                        { text: '存储', link: '/java/basic/storage' },
                        { text: '计算', link: '/java/basic/compute' },
                        { text: '条件分支', link: '/java/basic/if' },
